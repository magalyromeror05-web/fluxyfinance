...
const FluxyLogo = ({ className = "h-8" }: { className?: string }) => (
  <svg viewBox="0 0 120 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="38" y="23" fontFamily="'Syne', sans-serif" fontWeight="800" fontSize="20" fill="currentColor">
      Fluxy
    </text>
  </svg>
);
...
export default function FluxyLanding() {
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "'DM Sans', 'Plus Jakarta Sans', system-ui, sans-serif" }}>
